...
export const metadata: Metadata = {
  ...
  openGraph: {
    images: [{ url: '/images/og-gouvernance.jpg', width: 1200, height: 630 }],
  },
};
  ...
  return (
    <>
      ...
      <Section variant="slate" padding="hero" className="relative overflow-hidden">
        <img src="/images/hero-gouvernance.webp" alt="" className="absolute inset-0 w-full h-full object-cover opacity-60" />
